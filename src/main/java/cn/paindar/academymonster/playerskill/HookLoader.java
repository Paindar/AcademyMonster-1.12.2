...
import static cn.academy.ability.vanilla.electromaster.CatElectromaster.thunderBolt;
...
public class HookLoader {
    ...
    public static void init()
    {
        ...
        if(removeSkill(CatElectromaster.railgun)) {
            VanillaCategories.electromaster.addSkill(railgun_);
        }
        ...
        if(removeSkill(CatMeltdowner.meltdowner)) {
            ...
            if(setParentSkill(CatMeltdowner.mineRayBasic, meltdowner_) &&
                ...
                VanillaCategories.meltdowner.addSkill(meltdowner_);
            }
            else{
                AcademyMonster.log.error("Failed to replace meltdowner's skill.");
                VanillaCategories.meltdowner.addSkill(Meltdowner$.MODULE$);
